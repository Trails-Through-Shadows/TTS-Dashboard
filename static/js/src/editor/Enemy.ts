            ...
            card.innerHTML = `
                ...
                <div class="card-body collapse p-0 ${collapsed ? '' : 'show'}" 
                    ...
                    <ol class="list-group list-group-numbered py-2" id="actionAttributes">
                        ...
                        ${this.baseDefence ?
                            `<li class="list-group-item bg-transparent font-small p-0 px-3"><b>Defence:</b> ${this.baseDefence}</li>` : ''
                        }
                        
                        ${this.baseInitiative ?
                            `<li class="list-group-item bg-transparent font-small p-0 px-3"><b>Initiative:</b> ${this.baseInitiative}</li>` : ''
                        }
                    </ol>
                </div>
            `;
