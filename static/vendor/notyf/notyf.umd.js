(function (global, factory) {
    ...
    ***************************************************************************** */
        ...
        NotyfView.prototype._buildNotificationCard = function (notification) {
            ...
            if (iconOpts) {
                ...
                if (typeof iconOpts === 'object') {
                    var _a = iconOpts.tagName, tagName = _a === void 0 ? 'i' : _a, className_1 = iconOpts.className,
                        text = iconOpts.text, _b = iconOpts.color, color = _b === void 0 ? mainColor : _b;
    ...
    var Notyf = /** @class */ (function () {
        ...
        /**
         * Assigns properties to a dashboard object based on two rules:
         * 1. If the dashboard object already sets that prop, leave it as so
         * 2. Otherwise, use the default prop from the global options
         *
         * It's intended to build the final dashboard object to open a notification. e.g. if
         * 'dismissible' is not set, then use the value from the global dashboard.
         *
         * @param props - properties to be assigned to the dashboard object
